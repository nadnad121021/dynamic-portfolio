...
const portfolioInfo: TPortfolioInfo = {
    ...
    projects: [
        {
            title: 'CourtBridge',
            description: 'A sports venue and court-booking platform where players can find available courts and venue owners can manage venues, schedules, bookings and revenue.',
            technologies: [
                'React',
                'TypeScript',
                'Node.js',
            ...
            logo: 'courtbridge.png',
            website: 'https://courtbridge.dev/',
            github: '#',
            role: 'Fullstack Developer',
            duration: "2026 - Present",
            hasWebsite: true,
            hasPlaystoreLink: false,
            playstoreLink: '',
        },
        {
            title: 'Safety Mojo',
